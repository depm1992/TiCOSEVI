...
public class Preguntas {
    ...
    public void cargarPreguntas(){
        ...
        Pregunta pre2 = new Pregunta(0, "Significa aumentar la contaminación de nuestro planeta, el consumo de combustible y atentar contra la salud:\n",
                "N/D", "Comprobar el buen estado de los dispositivos del sistema de control de emisiones del motor.\n",
        ...
        Pregunta pre6 = new Pregunta(4, "Cuál es un componente del sistema de escape?:",
                "N/D", "Catalizador.", "Carburador.", "Bobina.", "Catalizador.");
        Pregunta pre7 = new Pregunta(5, "Se suspenderá la licencia a aquel conductor que en categoría común o profesional:",
                "N/D", "Acumule 6 puntos.", "Acumule 12 puntos o más.", "Acumule 6 puntos o más.", "Acumule 12 puntos o más.");
        Pregunta pre8 = new Pregunta(6, "En las curvas:", "N/D", "Durante la noche utilizar la luz alta para tener mayor visibilidad.",
        ...
        Pregunta pre9 = new Pregunta(7, "Además de aire y calor(chispa), que más se necesita para que el motor funcione:", "N/D",
        ...
        Pregunta pre11 = new Pregunta(9, "Asegurarse de las buenas condiciones del vehículo y del conductor es una norma primordial que se debe observar y cumplir:", "N/D",
        ...
        Pregunta pre14 = new Pregunta(12, "¿Para obtener una licencia de conducir clase C se necesita haber obtenido la aprobación del Curso Básico de Educación Vial para Transporte Público?", "N/D",
                "Verdadero.", "Falso.", "N/D", "Verdadero.");
        Pregunta pre15 = new Pregunta(13, "La ley 9078 lleva como nombre:", "N/D",
        ...
        Pregunta pre16 = new Pregunta(14, "En el semáforo vehicular la luz roja intermitente es equivalente a:", "semaforo",
                ...
                "Una señal de alto.");
        Pregunta pre17 = new Pregunta(15, "¿El sueño en la conducción puede ser provocado por?", "N/D",
                "El exceso de velocidad.", "La hora del día en que se maneje.", "El calor ambiental.",
                "La hora del día en que se maneje.");
        Pregunta pre18 = new Pregunta(16, "Una llanta con mucha presión:", "N/D",
        ...
        Pregunta pre19 = new Pregunta(17, "El lugar de la vía pública donde convergen 2 o más vías es:", "N/D",
        ...
        Pregunta pre20 = new Pregunta(18, "La trilogía vial se compone de 3 elementos, ¿Cuál elemento completa la siguiente imagen?", "triangulo",
                ...
                "Factor humano.");
        Pregunta pre21 = new Pregunta(19, "Estos son los tres tipos de señalamiento luminoso:", "N/D",
        ...
        Pregunta pre22 = new Pregunta(20, "A que conductor que en categoría novato acumule 6 puntos en su licencia recibe una suspensión de la misma por un período de:", "N/D",
        ...
        Pregunta pre25 = new Pregunta(23, "La acera es parte de la vía:", "N/D",
                "Urbana.", "Rural.", "Rural y urbana.", "Urbana.");
        Pregunta pre26 = new Pregunta(24, "Educar al ciudadano en el uso correcto de la vía pública y sus automotores  es un objetivo de:", "N/D",
                "MOPT.", "Seguridad vial.", "COSEVI.", "Seguridad vial.");
        Pregunta pre27 = new Pregunta(25, "El \"derecho a circular\" está protegido constitucionalmente en:", "N/D",
        ...
        Pregunta pre28 = new Pregunta(26, "Un buen hábito, para el ejercicio de una conducción económica es:", "N/D",
        ...
        Pregunta pre29 = new Pregunta(27, "El oficial procederá al retiro temporal de un vehículo en el siguiente caso:", "N/D",
                ...
                "Cuando las condiciones mecánicas del vehículo le impidan circular, salvo que el conductor contrate los servicios privados de acarreo.");
        Pregunta pre30 = new Pregunta(28, "Las láminas ubicadas en postes o lugares elevados, pertenecen al tipo de dispositivos:", "N/D",
                "Verticales.",
                "Horizontales.","Luminosos.",
                "Verticales.");
        Pregunta pre31 = new Pregunta(29, "Cuando el conductor se sienta alterado por alguna condición mental o emocional, se recomienda:", "N/D",
        ...
        Pregunta pre32 = new Pregunta(30, "Por definición, sanción es:", "N/D",
        ...
        Pregunta pre33 = new Pregunta(31, "¿El sistema de escape evacúa los gases quemados que resultan del proceso de combustión?", "N/D",
                "Falso.",
                "Verdadero.","N/D", "Verdadero.");
        Pregunta pre34 = new Pregunta(32, "El oficial procederá al retiro temporal de un vehículo en el siguiente caso:", "N/D",
                ...
                "Cuando el vehículo sea conducido por vía pública sin estar inscrito en el Registro Nacional.");
        Pregunta pre35 = new Pregunta(33, "La rotonda:", "N/D",
                ...
                "Es una construcción vial diseñada para facilitar los cruces de vías.");
        Pregunta pre36 = new Pregunta(34, "Una llanta con poca presión:", "N/D", "Se desgastará más a los lados.", "Se desgastará más en el centro.",
                "Da más estabilidad al vehículo.", "Se desgastará más a los lados.");
        Pregunta pre37 = new Pregunta(35, "Según lo dispuesto en la Ley de Tránsito, un requisito de tipo formal para conducir un vehículo es:", "N/D",
                "Carrocería en buen estado.", "Título de propiedad.",
                "Certificado de curso teórico aprobado.", "Título de propiedad.");
        Pregunta pre38 = new Pregunta(36, "Los captaluces de color blanco se pueden usar como complemento para la:", "N/D",
                "Línea de vía.", "Línea de barrera.",
                "Línea de centro.", "Línea de vía.");
        Pregunta pre39 = new Pregunta(37, "Como complemento a la línea de borde se utilizan captaluces de color rojo para:", "N/D",
        ...
        Pregunta pre40 = new Pregunta(38, "Se sanciona al chofer de moto o bimoto con 4 puntos cuando:", "N/D",
                "Transporte a niños menores de 5 años.", "Hable por celular.",
                "Adelante en curva.", "Transporte a niños menores de 5 años.");
        Pregunta pre41 = new Pregunta(39, "La regla más recomendable para seguir a otro vehículo, ¿Se basa en?", "v",
        ...
        Pregunta pre44 = new Pregunta(42, "Los tambores y pastillas son componentes del sistema de:", "N/D",
                "Dirección.", "Embrague.", "Frenos.", "Frenos.");
        Pregunta pre45 = new Pregunta(43, "Quien maneja a la defensiva debe:", "N/D",
        ...
        Pregunta pre46 = new Pregunta(44, "Aumenta la distancia de reacción:", "N/D",
                "Alcohol y fatiga.", "Fatiga y temeridad.", "Exhibicionismo y agresividad", "Alcohol y fatiga.");
        Pregunta pre47 = new Pregunta(45, "La contaminación calórica causa:", "N/D",
        ...
        Pregunta pre48 = new Pregunta(46, "Un objetivo de la seguridad vial es:", "N/D",
        ...
        Pregunta pre49 = new Pregunta(47, "¿Cuál es un componente del sistema eléctrico?", "N/D",
                "Carburador.", "Carter.", "Alternador.", "Alternador.");
        Pregunta pre50 = new Pregunta(48, "Consiste en un grado de elevación mayor en uno de los extremos de la calzada:", "N/D",
        ...
        Pregunta pre52 = new Pregunta(50, "Son para el cruce de peatones en lugares con gran tránsito peatonal, se pintan como franjas anchas discontinuas paralelas entre sí:", "N/D",
                "Zona de seguridad.", "Zona de peatones.",
                "Zona de paso.", "Zona de seguridad.");
        Pregunta pre53 = new Pregunta(51, "En que consiste el manejo seguro al conducir:", "N/D",
                ...
                "Es una serie de buenos hábitos preventivos mediante los cuales se evitan accidentes de tránsito.");
        Pregunta pre54 = new Pregunta(52, "Se caracteriza porque aprovecha la energía de los gases resultantes de la combustión:", "N/D",
        ...
        Pregunta pre58 = new Pregunta(56, "¿Qué es el hidroplaneamiento?", "N/D",
                ...
                "La pérdida de contacto de las llantas del vehículo con la superficie de rodamiento a causa del agua.");
        Pregunta pre59 = new Pregunta(57, "Las prohibiciones que derivan en multas, suspensión de licencias o el retiro de circulación de un vehículo se encuentran establecidas en:", "N/D",
                "La Educación Vial.", "La Ley de Tránsito.",
                "La Seguridad Vial.", "La Ley de Tránsito.");
        Pregunta pre60 = new Pregunta(58, "El exceso de ruido es un tipo de contaminación atmosférica:", "N/D",
                "Sónica.", "Eletromagnética.",
                "Calórica.", "Sónica.");
        Pregunta pre61 = new Pregunta(59, "Las multas más altas, tipo A, se aplicarán:", "N/D",
        ...
        Pregunta pre63 = new Pregunta(61, "¿La zona destinada a generar espacio para las emergencias se llama?", "N/D",
                "Canaleta.", "Calzada.", "Espaldón.", "Espaldón.");
        Pregunta pre64 = new Pregunta(62, "Como complemento a la línea de vía se utilizan captaluces de color:", "N/D",
                "Blanco.", "Rojo.", "Amarillo.", "Blanco.");
        Pregunta pre65 = new Pregunta(63, "Para prevenir el choque de frente al adelantar, ¿Qué debemos hacer?", "N/D",
        ...
        Pregunta pre67 = new Pregunta(65, "¿Cuáles son 2 condiciones emocionales o mentales que afectan la capacidad del conductor para manejar con seguridad?", "N/D",
                "Fatiga y agresividad.", "Sueño y cólera.",
                "Negligencia y vanidad.", "Negligencia y vanidad.");
        Pregunta pre68 = new Pregunta(66, "Si pensamos abandonar una rotonda por la primera salida, debemos utilizar:", "N/D",
                "El carril externo.", "Cualquier carril.",
                "El carril interno.", "El carril externo.");
        Pregunta pre69 = new Pregunta(67, "Advertir al usuario sobre la existencia de posibles peligros y óbstaculos en la vía es una función de:", "N/D",
        ...
        Pregunta pre71 = new Pregunta(69, "El factor lambda:", "N/D",

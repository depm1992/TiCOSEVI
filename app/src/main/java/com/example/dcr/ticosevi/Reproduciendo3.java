...
public class Reproduciendo3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reproduciendo3);
    ...
    public void ReproducirVideoEnrawMulta1() {
        VideoView videoView = (VideoView)findViewById(R.id.pantalla);
